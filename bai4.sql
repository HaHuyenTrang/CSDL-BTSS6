...
from Products where price >(select Price from Products where ProductName like 'MacBook Air');

-- 3
 
select
ProductName, Category, Price
from Products where category like 'Electronics' and price < (select price from Products where ProductName like 'Laptop');

--  4
select
ProductName, Price, Stock
from Products where stock <(select stock from Products where ProductName like 'T-Shirt') ;
